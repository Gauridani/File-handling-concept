...
outFile.write( reinterpret_cast < const  char *>(&employee), 
sizeof (employee)); 
outFile.close(); 
cout  <<  "Employee data written to binary file successfully!"  << 
endl ; 
} 
...
cerr  <<  "Error: Could not read data from the binary file!"  << 
endl ; 
} 
inFile.close(); 
} 
